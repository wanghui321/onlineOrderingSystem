...
$.ajax({
	type:"post",
	url:"<%=path%>/businessController/getNewOrders.do",
	dataType:'json',
	success:function(data){
		...
		for(var i = 0; i < data.length; i++){
			...
			str += '<span style="font-size: 15px;float: right;">'+data[i].phone+'</span></div>';
			str += '<div style="width: 98%;height: 30px;line-height:30px; background-color: #fff;">';
			str += '<span style="font-size: 15px;float: left;">'+data[i].address+'</span>';
			...
			str += '<span style="float: left;;height: 30px;line-height: 30px;font-size: 15px;margin-left: 100px;">展开</span>';
